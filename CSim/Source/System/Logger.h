...
public:
    ...
    [[nodiscard]] static bool LogError(const std::string& message) { return LogError(message.c_str()); }
    [[nodiscard]] static bool LogWarning(const std::string& message) { return LogWarning(message.c_str()); }
    [[nodiscard]] static bool LogInfo(const std::string& message) { return LogInfo(message.c_str()); }
    [[nodiscard]] static bool Log(const std::string& message) { return Log(message.c_str()); }
    [[nodiscard]] static bool LogTrace(const std::string& message) { return LogTrace(message.c_str()); }
    ...
    */
    ...
    static CommandLine* getCommandLine() { return instance ? instance->commandLine : nullptr; }
