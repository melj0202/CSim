    ...
    private:
        ...
        KeyCode TranslateKeyCodeToGLFW(int glfwKey) {
            switch (glfwKey) {
                ...
                case GLFW_MOUSE_BUTTON_LEFT: return KeyCode::MouseLeft;
                case GLFW_MOUSE_BUTTON_RIGHT: return KeyCode::MouseRight;
                case GLFW_MOUSE_BUTTON_MIDDLE: return KeyCode::MouseMiddle;
                case GLFW_MOUSE_BUTTON_4: return KeyCode::MouseButton4;
                case GLFW_MOUSE_BUTTON_5: return KeyCode::MouseButton5;
                case GLFW_MOUSE_BUTTON_6: return KeyCode::MouseButton6;
                case GLFW_MOUSE_BUTTON_7: return KeyCode::MouseButton7;
                case GLFW_MOUSE_BUTTON_8: return KeyCode::MouseButton8;
            ...
            switch (keyCode) {
                ...
                case KeyCode::MouseLeft: return GLFW_MOUSE_BUTTON_LEFT;
                case KeyCode::MouseRight: return GLFW_MOUSE_BUTTON_RIGHT;
                case KeyCode::MouseMiddle: return GLFW_MOUSE_BUTTON_MIDDLE;
                case KeyCode::MouseButton4: return GLFW_MOUSE_BUTTON_4;
                case KeyCode::MouseButton5: return GLFW_MOUSE_BUTTON_5;
                case KeyCode::MouseButton6: return GLFW_MOUSE_BUTTON_6;
                case KeyCode::MouseButton7: return GLFW_MOUSE_BUTTON_7;
                case KeyCode::MouseButton8: return GLFW_MOUSE_BUTTON_8;
                default: return -1;
            }
        }
        ...
        [[nodiscard]] InputAction TranslateInputActionGLFW(int glfwAction) {
            switch (glfwAction) {
                ...
                case GLFW_REPEAT: return InputAction::Hold;
    ...
    public:
        ...
        void update(){
            ...
            *scrollOffset = 0.0;
            ...
            for(KeyCode keyCode : AllKeyCodes) {
                ...
                if (inputStatesCurrent[keyCode] == InputAction::Press && inputStatesPrevious[keyCode] == InputAction::Press) {
                    inputStatesCurrent[keyCode] = InputAction::Hold;
                }   

                else if (inputStatesCurrent[keyCode] == InputAction::Press && inputStatesPrevious[keyCode] == InputAction::Hold) {
                    inputStatesCurrent[keyCode] = InputAction::Hold;
                }   


                else if (inputStatesCurrent[keyCode] == InputAction::Release && inputStatesPrevious[keyCode] == InputAction::Release) {
                    inputStatesCurrent[keyCode] = InputAction::None;
                }
        ...
        InputAction GetInputAction(KeyCode keyCode) {
            ...
            if (keyCode >= KeyCode::MouseLeft) {
                glfwInputAction = glfwGetMouseButton(window, TranslateKeyCodeFromGLFW(keyCode));
            } else {
        ...
        bool isMouseButtonPressed(KeyCode mouseButton) {
            int glfwInputAction = glfwGetMouseButton(window, TranslateKeyCodeFromGLFW(mouseButton));
        ...
        static void normalKeyCallback(GLFWwindow* /*window*/, const int key, int /*scancode*/, const int action, const int /*mods*/)
        {
            if (s_Instance) {
                KeyCode localKey = s_Instance->TranslateKeyCodeToGLFW(key);
                InputAction localAction = s_Instance->TranslateInputActionGLFW(action);
                s_Instance->keyQueue.push({localKey, localAction});
            }
        }
