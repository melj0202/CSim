...
private:
    ...
    unsigned int m_VboID = 0; // The raw vertex data bucket (Positions, Colors, UVs)
    unsigned int m_IboID = 0; // The raw index data bucket (The order to connect triangles)
    
    size_t m_VertexCount = 0;
    size_t m_IndexCount  = 0;

public:
    GLBuffer(const void* vertexData, size_t vertexSize, const void* indexData, size_t indexSize) {
        ...
        // CRITICAL NOTE: When a VAO is bound, it permanently remembers the IBO binding!
