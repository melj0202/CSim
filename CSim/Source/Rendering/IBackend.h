...
public:
	...
	// layout + dynamic: when dynamic, vertexSize is VBO capacity and vertices may be null.
	virtual unsigned long CreateMesh(const void* vertices, size_t vertexSize, const void* indices, size_t indexSize, unsigned long tableID, MeshVertexLayout layout, bool dynamic) = 0;
