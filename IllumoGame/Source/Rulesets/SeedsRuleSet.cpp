...
unsigned char
SeedsRuleSet::nextState(unsigned char cell, unsigned char aliveNeighbors) const
{
...
void
SeedsRuleSet::evalCell(const unsigned char& target, unsigned char dest[3]) const
{
  if (target == CELL_DEAD) {
