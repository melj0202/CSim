...
public:
	...
	std::vector<std::string> ParseCommandArgs(const std::string& text, const std::string& delim) const;
...
private:
	...
	std::vector<std::string> getCompletionCandidates(const std::string& leadingText) const;
};
