/*
    This class describes a RenderWindow that uses the Metal rendering API and
   Cocoa windowing api as Apple requires the its usage in the current versions
   of macOS since their support of OpenGL is non existent.
*/
#include <GL/glew.h>
...
public:
  ...
  static std::array<int, 2> getWindowDimensions()
  {
