...
static int runMockBackendCase(void (*testFunction)())
{
	g_failures = 0;
	testFunction();
	return g_failures;
...
void registerMockBackendTests(IllumoTestRegistry& registry)
{
	registry.add("Illumo.MockBackend.Lifecycle", []() { return runMockBackendCase(testLifecycle); });
	registry.add("Illumo.MockBackend.CreateRecords", []() { return runMockBackendCase(testCreateRecords); });
	registry.add("Illumo.MockBackend.CommandSubmit", []() { return runMockBackendCase(testCommandSubmit); });
	registry.add("Illumo.MockBackend.ProofLikeSequence", []() { return runMockBackendCase(testProofLikeSequence); });
	registry.add("Illumo.MockBackend.CanvasLikeUpdateTexture", []() { return runMockBackendCase(testCanvasLikeUpdateTexture); });
}
