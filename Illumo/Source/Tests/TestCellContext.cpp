...
{
  registry.add("Illumo.CellContext.NormalizeMode",
               []() { return runCellContextCase(testNormalizeModeString); });
  registry.add("Illumo.CellContext.KnownModes",
               []() { return runCellContextCase(testIsKnownModeString); });
  registry.add("Illumo.CellContext.RuleSetSwitch",
               []() { return runCellContextCase(testSetRuleSetAndTags); });
  registry.add("Illumo.CellContext.InvalidModeFallback", []() {
    return runCellContextCase(testInvalidModeFallsBackToGoL);
  });
  registry.add("Illumo.CellContext.CanvasDimensions", []() {
