...
{
  registry.add("Illumo.Canvas.ClearAndSetGet",
               []() { return runCanvasDomainCase(testClearAndSetGet); });
  registry.add("Illumo.Canvas.Dimensions",
               []() { return runCanvasDomainCase(testDimensions); });
  registry.add("Illumo.Canvas.ClearMarksUpload",
               []() { return runCanvasDomainCase(testClearMarksUpload); });
  registry.add("Illumo.Canvas.DefaultPalette",
               []() { return runCanvasDomainCase(testDefaultPalette); });
  registry.add("Illumo.Canvas.FadeTowardTarget",
               []() { return runCanvasDomainCase(testFadeTowardTarget); });
  registry.add("Illumo.Canvas.EnrollCreatesHandles", []() {
    return runCanvasDomainCase(testEnrollCreatesGpuHandles);
  });
  registry.add("Illumo.Canvas.DirtySparseUpload", []() {
