...
\begin{itemize}
  \item Domain: \texttt{lifeCanvas}, dims, get/set, dirty rects.
  \item View: mesh + R8 cell texture + palette texture + canvas shaders;
        dirty-rect \texttt{UpdateTexture}; draw with MVP.
\end{itemize}
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Phase 3 --- Canvas tokens} \quad \textbf{done}
        (later evolved to R8 + palette; see D-P4)
