...
\pathref{CSim/Shader/canvas\_*.glsl} & R8 + palette presentation \\
...
\begin{itemize}
  ...
  \item \pathref{archive/dead-engine/} --- unused EntityTable / ModuleObject (D-E3).
