...
\texttt{CSimRenderTests} / CTest \texttt{MockBackend}; the current canonical
target and CTest name are \texttt{CSimTests}, with the old names retained only
...
\textbf{Consequences:} CI can run \texttt{ctest -R CSimTests}; second real API
