...
An overview and fix of the Illumo codebase to get it into a fully working state (compiling, linking, running, and properly rendering scene data).

Working directory: `<local checkout>/Illumo`
Integrity mode: demo
...
### Build & Run
- [ ] The Illumo project compiles cleanly using CMake/MSBuild on Windows with no errors.
