...
| UI tokens + console | `TestUITokens.cpp` | CommandLine editing/completion/validation/dispatch/help; open/closed/invisible tokens; full-help mesh-capacity regression; GLString empty/FPS; combined scene |
