...
\begin{statusbox}
As of 2026-08-09 (current-state audit): packages under \pathref{App},
\pathref{Engine}, \pathref{Game}, \ldots; the reusable 2D token renderer has
typed generational resources, managed texture/shader assets, painter-correct
primitives, and mock tests;
