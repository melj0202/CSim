...
\begin{statusbox}
As of 2026-08-04 (current-state audit): packages under \pathref{App},
...
display texture; rules are double-buffered; headless \texttt{IllumoTests} runs
as part of the default build; the command console has measured editing,
