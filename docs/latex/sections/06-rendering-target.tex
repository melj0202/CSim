...
\begin{itemize}
  \item Domain: \texttt{SparseCellGrid}, signed coordinates, 16$\times$16
        chunks, and adaptive candidate/18$\times$18 halo stepping.
...
\begin{itemize}
  \item Font atlases, UTF-8 measurement/wrapping, clipping, and nine-slice UI.
  \item Chunked tilemaps, sprite culling, and particle emitters.
  \item Multiple cameras, offscreen targets, compositing, and post-processing.
  \item Standalone renderer extraction only after a second real project proves
        the public boundary (D-R19).
