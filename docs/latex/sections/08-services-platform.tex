...
\begin{itemize}
  ...
  \item \textbf{Config} --- \symbolref{EnvVars} / \symbolref{IEnvVars}
        ...
        mode string, \ldots). The production file is \texttt{envvars.json}
  ...
  \item \textbf{CLI} --- \symbolref{CommandLine} (token UI when open; batched
        ...
        Startup help/version and window/canvas dimension options are applied
        before the render window is constructed.
        ...
        Debug-only product composition (D-B1, D-CLI1, D-UI1--D-UI3).
