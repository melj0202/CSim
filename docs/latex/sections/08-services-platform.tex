...
\begin{itemize}
  ...
  \item \textbf{CLI} --- \symbolref{CommandLine} (token UI when open; batched
        ...
        deletion, history, quoted arguments, measured caret placement, and a
        horizontally scrolling input viewport. The easy-font batch is sized for
        6,000 UI quads so a detailed help page is not truncated. The console is
