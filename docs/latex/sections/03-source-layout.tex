...
\pathref{Rendering/} & Typed resources, managed texture/shader assets, painter-correct 2D primitives, Scene/tokens, OpenGL, Mock. \\
...
\pathref{Assets/} & First-party runtime data copied beside the executable. \\
...
\begin{itemize}
  ...
  \item \pathref{Illumo/Assets/} --- runtime files (fonts and the Debug
        renderer-demo atlas/shader).
  ...
  \item \pathref{docs/} --- canonical technical documentation: current
        Markdown, package maps, dated sessions, history, a prose book, a
        chart-only map, and generated output.
  \item Root and nested \texttt{AGENTS.md} files plus \pathref{.agent/} ---
        D-DOC2 operational exceptions, not technical-documentation owners.
\end{itemize}
