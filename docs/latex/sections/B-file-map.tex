...
\pathref{Rendering/Primitives/*} & GameVisual, transforms, atlas sprites, animation, UiTheme \\
...
\pathref{Rendering/GLString.*} & Text tokens, geometry cache, optional panel chrome \\
\pathref{Rendering/SplashText.*} & Fading themed mode notice \\
\pathref{Services/CommandLine.*} & Primitive-composed console UI (batched) \\
